                ...
                <div class="row text-center">
                    ...
                    <h2 class="nomartop judulRegistrasi"><b>Surat Izin Kerja (SIK) / Surat Izin Praktek (SIP) Terapis Wicara</b></h2>                    
                </div>
                ...
                <div class="row">
                    <div class="kotakform col-lg-12">
                        ...
                        <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">No STRTW :</label>
                                <div class="col-sm-8"> 
                                <input type="text" class="form-control" id="pwd" placeholder="Masukkan No. STRTW">
                                </div>
                            </div>
                            ...
                            <!-- COMPONENT START -->
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Scan Ijazah </label>
                                <div class="col-sm-8">
                                    <div class="input-group input-file" name="Fichier1">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-choose" type="button">Pilih</button>
                                        </span>
                                        <input type="text" class="form-control" placeholder='Upload Scan Ijazah yang Dilegalisir ' />
                                        <span class="input-group-btn">
                                            <button class="btn btn-warning btn-reset" type="button">Reset</button>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Scan STRTW </label>
                                <div class="col-sm-8">
                                    <div class="input-group input-file" name="Fichier1">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-choose" type="button">Pilih</button>
                                        </span>
                                        <input type="text" class="form-control" placeholder='Upload Scan STRTW yang masih berlaku dan dilegalisir ' />
                                        <span class="input-group-btn">
                                            <button class="btn btn-warning btn-reset" type="button">Reset</button>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Scan Rekomendasi Organisasi Profesi (IKATIWI) </label>
                                <div class="col-sm-8">
                                    <div class="input-group input-file" name="Fichier1">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-choose" type="button">Pilih</button>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Scan SIKTW atau SIPTW pertama/kedua </label>
                                <div class="col-sm-8">
                                    <div class="input-group input-file" name="Fichier1">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-choose" type="button">Pilih</button>
                                        </span>
                                        <input type="text" class="form-control" placeholder='Bagi permohonan SIKTW atau SIPTW kedua' />
                                        <span class="input-group-btn">
                                            <button class="btn btn-warning btn-reset" type="button">Reset</button>
                                        </span>
                                    </div>
