                ...
                <div class="row text-center">
                    ...
                    <h2 class="nomartop judulRegistrasi"><b>Surat Izin Kerja (SIK) / Surat Izin Praktek (SIP) Fisioterapis</b></h2>                    
                </div>
                ...
                <div class="row">
                    <div class="kotakform col-lg-12">
                        ...
                        <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">No STRF :</label>
                                <div class="col-sm-8"> 
                                <input type="text" class="form-control" id="pwd" placeholder="Masukkan No. STRF">
                                </div>
                            </div>
                            ...
                            <!-- COMPONENT START -->
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Scan STRF </label>
                                <div class="col-sm-8">
                                    <div class="input-group input-file" name="Fichier1">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-choose" type="button">Pilih</button>
                                        </span>
                                        <input type="text" class="form-control" placeholder='Upload Scan STRF yang berlaku ' />
                                        <span class="input-group-btn">
                                            <button class="btn btn-warning btn-reset" type="button">Reset</button>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Scan Rekomendasi Organisasi Profesi (IFI) </label>
                                <div class="col-sm-8">
                                    <div class="input-group input-file" name="Fichier1">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-choose" type="button">Pilih</button>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Scan SIKF atau SIPF pertama/kedua</label>
                                <div class="col-sm-8">
                                    <div class="input-group input-file" name="Fichier1">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-choose" type="button">Pilih</button>
                                        </span>
                                        <input type="text" class="form-control" placeholder='Untuk Permohonan SIKF atau SIPF kedua/ketiga' />
                                        <span class="input-group-btn">
                                            <button class="btn btn-warning btn-reset" type="button">Reset</button>
                                        </span>
                                    </div>
