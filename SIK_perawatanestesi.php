                ...
                <div class="row text-center">
                    ...
                    <h2 class="nomartop judulRegistrasi"><b>Surat Izin Kerja Perawat Anestesi</b></h2>                    
                </div>
                ...
                <div class="row">
                    <div class="kotakform col-lg-12">
                        ...
                        <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">No STRPA :</label>
                                <div class="col-sm-8"> 
                                <input type="text" class="form-control" id="pwd" placeholder="Masukkan No. STRPA">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Scan SIKPA pertama</label>
                                <div class="col-sm-8">
                                    <div class="input-group input-file" name="Fichier1">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-choose" type="button">Pilih</button>
                                        </span>
                                        <input type="text" class="form-control" placeholder='Untuk Permohonan SIKPA kedua' />
                                        <span class="input-group-btn">
                                            <button class="btn btn-warning btn-reset" type="button">Reset</button>
                                        </span>
                                    </div>
